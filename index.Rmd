...
* To run the workshop materials on your machine, you will need:
    ...
    - The following `R` packages: `tidyverse`, `sf`, `emo`, `janitor`, `palmerpenguins` and `lubridate.` You can install them all at once by running the following code in the `R` command line:

```{r eval = FALSE, echo = TRUE}
install.packages(c("tidyverse", "sf", "emo", "janitor", "palmerpenguins", "lubridate"))
```
